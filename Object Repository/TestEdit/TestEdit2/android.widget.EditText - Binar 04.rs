...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - Binar 04</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Binar 04' or . = 'Binar 04') and @resource-id = 'id.binar.fp.secondhand:id/edit_text']</locator>
