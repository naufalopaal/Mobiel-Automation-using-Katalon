...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Binar 04</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Binar 04' or . = 'Binar 04') and @resource-id = 'id.binar.fp.secondhand:id/data']</locator>
